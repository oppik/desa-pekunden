<div class="sidebar-menu">
    <ul class="menu">
        ...
        <li class="sidebar-item {{ request()->is('v1/packages*') ? 'active' : '' }}">
        ...
        <li class="sidebar-item {{ request()->is('v1/cities') ? 'active' : '' }}">
            <a href=# target="__blank" class='sidebar-link'>
        ...
        <li class="sidebar-item {{ request()->is('v1/cities') ? 'active' : '' }}">
            <a href="https://wa.me/6287862263522" target="__blank" class='sidebar-link'>
