...
<body>
    ...
    <figure class="fs-3 ">
        <blockquote class="fw-bold text-center">
            <p>Desa Wisata k.r.e.a.t.i.f </p>
            <p>Pekunden Banyumas</p>
        </blockquote>
    </figure>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{ asset('assets/wisata.jpg') }}" class="d-block w-100 shadow-nih" alt="...">
                    </div>
    ...
    <div class="container">
        <div class="clearfix">
            ...
            <img src="{{ asset('assets/image-removebg-preview.png') }}" class="col-md-3 float-md-end mb-3 ms-md-3"
                alt="...">

            <p>
                Desa Wisata Kreatif Pekunden dirintis mulai tahun 2018 dan diresmikan oleh Bupati Banyumas Ir. Achmad
                Husein pada tanggal 19 Desember 2021.
            </p>

            <p>
                Desa Wisata Kreatif Pekunden memiliki beberapa daya Tarik Wisata yaitu:
            </p>
            <ol>
                <li>Kampoeng Nopia Mino sebagai wisata ungguan.</li>
                <li>Oemah Gamelan</li>
                <li>Kebun Buah Naga</li>
                <li>Oemah Batik</li>
                <li>Oemah Manggleng</li>
                <li>Kampung Garment</li>
            </ol>
            <p>
                Dan daya tarik wisata lainnya
            </p>
            <p>
                Yang dikemas dalam beberapa paket wisata baik Half day, Full day, 2 day 1 night dengan paket harga
                terjangkau
            </p>
        </div>
    </div>
