            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form" action="{{ route('packages.update', $package->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <img src="{{ asset($package->image) }}" class="img-fluid shadow-sm"
                            ...
                            <div class="col-md-7">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        name="name" value="{{ old('name', $package->name) }}" autocomplete="off">
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control @error('price') is-invalid @enderror"
                                            name="price" value="{{ old('price', $package->price) }}" autocomplete="off">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('minimum_person') is-invalid @enderror"
                                        name="minimum_person" value="{{ old('minimum_person', $package->minimum_person) }}"
                                        autocomplete="off">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Thumbnail Paket Baru</label>
